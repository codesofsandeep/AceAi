...
//         </h1>
//         <p className="text-sm text-slate-400">Overview of your AI usage</p>
//       </div>
...
//         <h2 className="text-lg font-semibold text-slate-100">Recent Creations</h2>
...
//             <div className="w-full max-w-lg bg-slate-900 rounded-xl p-6 border border-slate-700 relative">
...
//                 <div className="bg-slate-800 p-3 rounded-md text-sm text-slate-200 max-h-48 overflow-y-auto">
//                   {selectedCreation.result}
//                 </div>
//               </div>
