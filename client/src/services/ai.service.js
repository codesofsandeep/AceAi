...
export const generateArticle = (data) =>
  api.post("/ai/generate-article", data);

export const generateBlogTitle = (data) =>
  api.post("/ai/generate-blog-title", data);

/* ========== IMAGE ========== */
export const generateImage = (data) =>
  api.post("/ai/generate-image", data);

export const removeBackground = (formData) =>
  api.post("/ai/image/remove-background", formData);

export const removeObject = (formData) =>
  api.post("/ai/remove-object", formData);

/* ========== RESUME ========== */
export const reviewResume = (formData) =>
  api.post("/ai/review-resume", formData);